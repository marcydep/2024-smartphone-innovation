...
The review may be written in any language. Analyze the meaning of the original text directly.
...
output.to_csv(
    "pilot_2_20_sentiment.csv",
    index=False,
    encoding="utf-8-sig"
)

print("\nPILOT COMPLETATO")
print("Salvato: pilot_2_20_sentiment.csv")